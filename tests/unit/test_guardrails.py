...
class TestValidateAnalysisConsistency:
    ...
    def test_buy_requires_quant_passed(self):
        assert (
            validate_analysis_consistency(
                "BUY", quant_screen_passed=False, moat_score=8, margin_of_safety=0.40
            )
            is False
        )
    ...
    def test_buy_requires_moat_ge_7(self):
        assert (
            validate_analysis_consistency(
                "BUY", quant_screen_passed=True, moat_score=5, margin_of_safety=0.40
            )
            is False
        )
    ...
    def test_buy_requires_mos_gt_30(self):
        assert (
            validate_analysis_consistency(
                "BUY", quant_screen_passed=True, moat_score=8, margin_of_safety=0.25
            )
            is False
        )
    ...
    def test_buy_all_pass_consistent(self):
        assert (
            validate_analysis_consistency(
                "BUY", quant_screen_passed=True, moat_score=8, margin_of_safety=0.40
            )
            is True
        )
    ...
    def test_no_buy_always_consistent(self):
        assert (
            validate_analysis_consistency(
                "NO_BUY", quant_screen_passed=False, moat_score=3, margin_of_safety=0.0
            )
            is True
        )
