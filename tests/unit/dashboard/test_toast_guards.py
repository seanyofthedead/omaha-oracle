...
class TestToastNotRepeatedOnRerun:
    ...
    def test_signals_toast_guarded(self):
        ...
        assert "page_toast_shown" in source, (
            "views/signals.py does not guard st.toast with page_toast_shown — "
    ...
    def test_cost_tracker_toast_guarded(self):
        ...
        assert "page_toast_shown" in source, (
            "views/cost_tracker.py does not guard st.toast with page_toast_shown — "
            "toast will fire on every rerun."
        )
